...
#ifndef ETHON_KOKKOS_CUDA_BLOCK_POOL_HPP_
#define ETHON_KOKKOS_CUDA_BLOCK_POOL_HPP_
...
public:
  ...
  using RefinementFlags_t = typename Block_t::RefinementFlags_t;

  BlockPool()
      : blocks_(N_blocks),
        refinement_flags("Refinement flags"),
        host_refinement_flags(Kokkos::create_mirror_view(refinement_flags)),
        cell_data("cell_data"),
        host_cell_data(Kokkos::create_mirror_view(cell_data)),
        x_fluxes("x_fluxes"),
        y_fluxes("y_fluxes"),
        z_fluxes("z_fluxes"),
...
public:
  // refinement flags
  RefinementFlags_t refinement_flags;
  typename RefinementFlags_t::HostMirror host_refinement_flags;
  ...
  typename CellData_t::HostMirror host_cell_data;

  CellData_t x_fluxes, y_fluxes, z_fluxes;
  FluxData_t lower_boundary, upper_boundary;
};

#endif // ETHON_KOKKOS_CUDA_BLOCK_POOL_HPP_
