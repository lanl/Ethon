...
#ifndef ETHON_KOKKOS_OMP_OUTPUT_HPP_
#define ETHON_KOKKOS_OMP_OUTPUT_HPP_
...
void DumpBlock(const typename BLOCK::CellData_t &dat,
  const BLOCK *block,
    double *data,
    double *x1f,
    double *x2f,
...
void DumpGrid(const std::string &fname,
    ...
    const Mesh_t &mesh,
    const EOS &eos,
    const typename BLOCK::CellData_t &dat,
...
#endif // ETHON_KOKKOS_OMP_OUTPUT_HPP_
